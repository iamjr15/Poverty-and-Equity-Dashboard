...
income_share_cols = [col for col in income_share_df.columns if col not in ['Country Name', 'Year']]
        ...
        dbc.Col([
            dbc.Tabs([            
                ...
                dbc.Tab([
                    html.Ul([
                        html.Br(),
                        html.Li('Designed and Developed by - Jigyansu Rout'),
                        html.Li([
                            'Website: ',
                            html.A('https://jigyansurout.me/', href='https://jigyansurout.me/')
                        ]),
                        html.Li([
                            'Email: ',
                            html.A('jigyanshu15@gmail.com', href='mailto:jigyanshu15@gmail.com')
                        ])
                    ])
                ], label='Project Info')
            ]),
